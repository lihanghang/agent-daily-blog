...
def create_draft_no_cover(token, title, author, digest, content, need_open_comment, only_fans_can_comment):
    """创建公众号草稿（不使用封面）"""
    payload = {
        "articles": [
            {
...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description="创建公众号草稿（不使用封面）")
